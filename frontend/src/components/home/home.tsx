        ...
        <div className="features">
          <div className="feature-card" onClick={() => handleClick(pageTopPosts)}>
            <div className="feature-icon">
              <img src={community} alt="community logo" style={{ width: '12rem', height: 'auto' }} />
            </div>
          ...
          <div className="feature-card" onClick={() => handleClick(pageWsbChatbot)}>
            <div className="feature-icon">
              <img src={chatbot} alt="chatbot logo" style={{ width: '12rem', height: 'auto' }} />
            </div>
            <h3>AI Chatbot</h3>
          ...
          <div className="feature-card" onClick={() => handleClick(pageTrading)}>
            <div className="feature-icon">
              <img src={stock} alt="stock logo" style={{ width: '12rem', height: 'auto' }} />
            </div>
